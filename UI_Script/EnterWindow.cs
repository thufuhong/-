...
public class EnterWindow : MonoBehaviour {
	...
	void Update () {
		...
		if (curIdx == 5) {
            ...
            transform.Find("EnterWindow").Find("Slide3").gameObject.SetActive(true);
        }
        if (curIdx == 4)
        {
            Button_next_text.text = "下一步";
            Button_quit_text.text = "退出游戏";
            message.text = message_1;
            transform.Find("EnterWindow").Find("Slide3").gameObject.SetActive(false);
            transform.Find("EnterWindow").Find("Slide1").gameObject.SetActive(true);
        }
        if (curIdx == 3)
        {
            Button_next_text.text = "下一步";
            Button_quit_text.text = "退出游戏";
            message.text = message_1;
            transform.Find("EnterWindow").Find("Slide1").gameObject.SetActive(false);
            transform.Find("EnterWindow").Find("Slide2").gameObject.SetActive(true);
        }
        if (curIdx == 2)
        {
            Button_next_text.text = "下一步";
            Button_quit_text.text = "退出游戏";
            message.text = message_1;
            transform.Find("EnterWindow").Find("Slide2").gameObject.SetActive(false);
            transform.Find("EnterWindow").Find("Slide5").gameObject.SetActive(true);
        }
        if (curIdx == 1)
        {
            Button_next_text.text = "下一步";
            Button_quit_text.text = "退出游戏";
            message.text = message_1;
            transform.Find("EnterWindow").Find("Slide5").gameObject.SetActive(false);
            transform.Find("EnterWindow").Find("Slide4").gameObject.SetActive(true);
        }
        if (curIdx == 0)
        {
            ...
            Button_quit_text.text = "退出游戏";
            message.text = message_1;
            transform.Find("EnterWindow").Find("Slide4").gameObject.SetActive(false);
            transform.Find("EnterWindow").Find("Slide6").gameObject.SetActive(true);
        }
        if (curIdx < 0) {
			// continue
			Time.timeScale = 1;
            transform.Find("Mask1").gameObject.SetActive(false);
	...
	{
		int level_num = PlayerPrefs.GetInt ("level_num", 1);
		if (level_num == 1)
		{
			// dynamic binding
			...
			+ "\n<b><size=15>        <color=blue>J </color>键攻击</size></b>"

...
public class Boss : MonoBehaviour {
    ...
    void OnParticleCollision(GameObject colli)
    {
        ...
        if (colli.name == "Skill_4 Partical")
        {
            ...
            float damage = (player.GetComponent<attribute>().ATK + player.GetComponent<attribute>().ATK_bouns*0.4f) * (player.GetComponent<ThirdPersonUserControl>().Skill_4_Value[0] + player.GetComponent<ThirdPersonUserControl>().Skill_4_Value[3] * player.GetComponent<attribute>().Skill_Level[3]);

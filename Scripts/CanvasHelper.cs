    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        if (name == "Skill_2")
            text1.text = "<b><size=25>自然之助 <color=blue>[I]</color></size></b>\n\n<size=15>斧王获得自然的祝福，瞬间恢复生命值，并且获得持续的治疗效果\n\n" +
                ...
                "</color></size>";
        if (name == "Skill_3")
            text1.text = "<b><size=25>亚登之盾 <color=blue>[O]</color></size></b>\n\n<size=15>斧王开启亚登之盾，短暂的免疫危险区域的伤害\n\n" +
        ...
        if (name == "Skill_4")
            text1.text = "<b><size=25>反击螺旋 <color=blue>[P]</color></size></b>\n\n<size=15>斧王召唤能量粒子攻击附近的单位，不受攻击距离的限制。\n\n" +
                ...
                "能量粒子攻击力：<color=red>" + ((c.Skill_4_Value[0] + c.Skill_4_Value[3] * _attr.Skill_Level[3])).ToString() + "</color>\n" +
                ...
                "<color=gray>下次升级：\n" +
                "能量粒子攻击力：" + ((c.Skill_4_Value[0] + c.Skill_4_Value[3] * (_attr.Skill_Level[3] + 1))).ToString() + "\n" +
